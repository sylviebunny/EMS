...
*
* Author: Sylvia Zhao
* Assignment: Implement CRUD methods for venue and venue address
...
public class VenueRepositoryImpl implements VenueRepository {
	...
	public int updateVenue(Venue venue) {
		...
		logger.info("Updating 'Venues' table Info: {}", pramSource);
		...
		updateVenueAddress(venue);
		return affectedRow;
	}
	
	/**
     * Update venue's address information
     * Map venue table to MySql parameters, update 'Venue_Address' table in database
     * 
     * @param venue : The information that needs to be updated.
     */
	private void updateVenueAddress(Venue venue) {
		String UPDATE_VADDRESS_INFO_PREFIX = "UPDATE `Venue_Address` SET ";
		String UPDATE_VADDRESS_INFO_SUFFIX = " WHERE Venue_ID = :venue_id";
		Map<String, Object> param1 = venue_addressMap(venue);
		SqlParameterSource pramSource1 = new MapSqlParameterSource(param1);
		logger.info("Updating 'Venue_Address' table Info: {}", pramSource1);
		...
		String UPDATE_VADDRESS = UPDATE_VADDRESS_INFO_PREFIX + UPDATE_VADDRESS_INFO + UPDATE_VADDRESS_INFO_SUFFIX;
